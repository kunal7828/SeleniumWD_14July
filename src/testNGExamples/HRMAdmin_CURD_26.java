...
//				driver.findElement(By.xpath("//label[text()='User Role']//following::span[text()='ESS']")).click();
	...
	public void searchUserName() throws Exception {
		...
		// driver.findElement(By.xpath("//label[text()='Username']//following::input[1]")).sendKeys(username1);
		Reporter.log("Enter Username In Search Field Successfully.----> " + username1, true);
		Thread.sleep(4000);
	}
	...
	public void selectUserRoleDD_2() throws Exception {
		...
		driver.findElement(By.xpath("//label[text()='User Role']//following::span[text()='" + userRole2 + "']"))
				.click();
//	    driver.findElement(By.xpath("//label[text()='User Role']//following::span[text()='ESS']")).click();
		Reporter.log("User Role Selected Successfully From Dropdown------> " + userRole2, true);
		Thread.sleep(2000);
	}
	// select Status from drop down
	...
	public void selectStatusDD_2() throws Exception {
		...
		// driver.findElement(By.xpath("//label[text()='Status']//following::span[text()='Disabled']")).click();
		Reporter.log("Status Selected Successfully From Dropdown----> "+ status2, true);
		Thread.sleep(2000);
	}
	// click on employee Name and select employee name from list.
	...
	public void selectEmployeeName_2() throws Exception {
		...
		Reporter.log("Type Employee Name ----> " + employeeName2, true);
		Thread.sleep(2000);
		driver.findElement(By.xpath("//label[text()='Employee Name']//following::span[1]")).click();
		Reporter.log("Employee Name Selected Successfully From List.", true);
		Thread.sleep(2000);
	}
	// enter Username1
	...
	public void enterUsername_2() throws Exception {
		...
		Reporter.log("Username Entered Successfully----> " + username2, true);
		Thread.sleep(2000);
	}
	...
	public void clickOnCheckBox() throws Exception {
		...
		Reporter.log("CheckBox icon clicked Successfully." + username2, true);
		Thread.sleep(2000);
	}
	// enter enterPassword1
	...
	public void enterPassword_2() throws Exception {
		...
		Reporter.log("Password Entered Successfully-----> " + password2, true);
		Thread.sleep(2000);
	}
	// enter enterConfirmPassword
	...
	public void enterConfirmPassword_2() throws Exception {
		...
		Reporter.log("Confirm Password Entered Successfully------>" + password2, true);
		Thread.sleep(2000);
	}
// click On SaveButton
	...
	public void searchUserName_2() throws Exception {
		...
		// input.sendKeys(username1);
		// driver.findElement(By.xpath("//label[text()='Username']//following::input[1]")).sendKeys(username1);
		Reporter.log("Enter Username In Search Field Successfully.----> " + username2, true);
		Thread.sleep(4000);
	}
	// click on search button.
	...
	public void clickOnSearchButton_2() throws Exception {
		...
		// + "']")).isDisplayed();
		Reporter.log("Updated User Name Found in Records -----> " + searchUserNameGetText, true);
		Thread.sleep(3000);
	}
